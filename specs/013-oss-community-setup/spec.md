...
- **SC-009**: Dependency-upgrade pull requests arrive within 7 days of an upstream release for both application dependencies and CI actions, and are labeled for triage.
