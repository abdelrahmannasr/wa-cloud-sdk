...
**Audience**: Consumers of `wa-cloud-sdk` who already have webhook verification working and want to react to template approval/rejection/quality changes.
...
```ts
import { parseWebhookPayload } from 'wa-cloud-sdk/webhooks';
