...
```ts
import { ConflictError } from 'wa-cloud-sdk';
...
```ts
import { WhatsAppMultiAccount } from 'wa-cloud-sdk/multi-account';
...
```ts
import { Catalog, type OrderEvent } from 'wa-cloud-sdk/catalog';
import { HttpClient } from 'wa-cloud-sdk/client';
