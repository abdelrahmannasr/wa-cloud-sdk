...
If you discover a security issue in `wa-cloud-sdk`, please report it privately by email to:
...
This policy covers the `wa-cloud-sdk` npm package only — that is, the TypeScript SDK code in this repository and its published artifacts.
